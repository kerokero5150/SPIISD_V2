...
But you can restart it by pressing `Command (Open-Apple) + Control + Power Key` at the same time to boot correctly. Now we ship V2.02, but if your SPIISD is using firmware earlier than V2.01, an update is possible, so please [contact us](https://www.kerosmm.com/お問い合わせ).<BR><BR>
