...
Additionally, try the following steps: Press `Open-Apple + Control + Escape` to access the Control Panel. In the Slots menu, set Startup Slot to **5** or **Auto**.<BR><BR>
